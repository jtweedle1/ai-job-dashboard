...
const features = [
  ...
  },
  {
    ...
    description: "Paste a job description and let AI fill in all the fields for you.",
  },
  {
    icon: "ti-target",
    title: "Role-fit scoring",
    description: "Get a 0–100 fit score for every role based on your resume and goals.",
  },
  {
    icon: "ti-mail",
  ...
  },
  {
    ...
    description: "Auto-fill company profiles with what they do, their values, and recent news.",
  },
  {
    icon: "ti-bookmarks",
    title: "Answer bank",
    description: "Save and search your best interview answers. Reuse what's working.",
  },
  {
    icon: "ti-clipboard-list",
    title: "Post-interview debrief",
    description: "Log what went well and what to improve after every interview.",
  },
  {
    icon: "ti-chart-bar",
    title: "Source analytics",
    description: "See which job sources are actually getting you responses and offers.",
  },
];

const stack = ["Next.js 16", "TypeScript", "Firebase", "Tailwind CSS", "Anthropic API", "Vercel"];
    ...
    <main className="min-h-screen bg-gray-50">
      ...
      <section className="max-w-3xl mx-auto px-6 pt-20 pb-16 text-center">
        ...
        <p className="text-xs text-gray-400 mt-3">
          Free to use. Bring your own Anthropic API key for AI features.
        </p>
      </section>
          ...
          {features.map((f) => (
            <div key={f.title} className="bg-white border border-gray-100 rounded-xl p-5">
              <div className="w-8 h-8 rounded-lg bg-emerald-50 flex items-center justify-center mb-3">
                <i className={`ti ${f.icon} text-emerald-600 text-base`} aria-hidden="true" />
              </div>
